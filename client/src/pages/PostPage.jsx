...
if(loading) return(
  ...
  <main className='flex flex-col p-3 max-w-6xl mx-auto min-h-screen'>
   <h1 className='text-3xl mt-10 p-3 text-center max-w-2xl mx-auto font-serif lg:text-4xl'>
    ...
    <img src={post && post.image} alt={post && post.title} className='mt-10 p-3 object-cover 
    max-h-[400px] w-full'/>
    <div className='flex justify-between p-3 border-b border-slate-500 mx-auto max-w-2xl w-full text-xs'>
